...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('hello_webrequest', 'priority',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('hello_webrequest', 'priority')
    ...
    models = {
        ...
        'hello.account': {
            ...
            'jabber': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True', 'null': 'True'}),
            'other_info': ('django.db.models.fields.TextField', [], {'blank': 'True', 'null': 'True'}),
            'skype': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True', 'null': 'True'}),
            'user': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['auth.User']", 'unique': 'True', 'related_name': "'account'"})
        },
        'hello.logs': {
